...
<div className=" w-[70%] my-auto">
  ...
  <p>by:{author}</p>
  <div className="lg:flex text-start items-center gap-5">
...
<div>
 ...
 <Link to={`wishBookDetails/${bookId}`}> <button className="p-2 text-[#FFFFFF] rounded-full bg-[#23BE0A]">View Details</button></Link>
</div>
  </section>
</div>
</div>
